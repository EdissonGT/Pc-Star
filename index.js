...
carritoElement.addEventListener('drop', (event) => {
    ...
    if (productoInfo) {
        ...
        // Actualizar la etiqueta 'cantidad-carrito' después de agregar un producto
        cantidadCarritoElement.textContent = obtenerCantidadCarrito();

        // Crear una imagen del producto en el carrito
        ...
        productoInfo = null; // Reiniciar la información del producto
    }
});
